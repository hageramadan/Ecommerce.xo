    ...
    <section className="px-5 lg:px-[18%] py-16 bg-gray-50 text-gray-800 leading-relaxed">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 text-[15px] max-w-2xl mx-auto">
           هو متجر واحد حيث يمكنك شراء كل شيء من الأثاث إلى الأدوات المنزلية وأكثر!
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 md:p-10">
        <ol className="list-decimal list-inside space-y-5 text-[15px] md:text-[16px] text-gray-700">
          ...
          <li>
            نحن نُعيد تعريف مفهوم "المنزل" — لدى  أكبر اختيار لتصميم وتأثيث وإنارة منزلك بنقرة واحدة، مع الراحة والتقنية التنبؤية والنهج المتمحور حول العميل.
          </li>
        </ol>
      </div>
    </section>
