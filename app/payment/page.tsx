        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          <div className="col-span-1 lg:col-span-2 h-fit">
            ...
            <div className="flex flex-col shadow rounded-xl my-4 p-6 gap-3">
              ...
              <div className=" mb-2">
                  <h3 className="border-b border-gray-300 pb-4 ps-4 text-xl font-semibold">عنوان الشحن</h3>
                <p className="ps-4 py-4 text-gray-700 font-semibold">التوصيل إلى 
                    <span>{" "} الجيزه</span>
                </p>
              </div>
                <div className="flex items-center justify-between bg-gray-50 p-4">
                    ...
                    <button className="text-pro-max underline font-bold cursor-pointer">تغيير</button>
                </div>
                </div> 
            </div>
              <div className="p-2 ps-6 shadow rounded-xl my-4">
