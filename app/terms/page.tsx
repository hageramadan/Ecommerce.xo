    ...
    <section className="px-5 lg:px-[18%] py-16 bg-gray-50 text-gray-800 leading-relaxed">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 text-[15px] max-w-2xl mx-auto">
          نُرحّب بك في <span className="font-semibold text-pro">هومزمارت</span>، المنصة التي تربط أصحاب المنازل
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 md:p-10 space-y-6">
        <section>
          ...
          <p className="text-gray-700 text-[15px]">
            من خلال الوصول إلى موقع هومزمارت أو استخدام خدماتنا، فإنك توافق على هذه الشروط والأحكام.
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-[15px] text-gray-700">
            ...
            <li>يحتفظ هومزمارت بحق تعليق أو حذف أي حساب يخالف هذه الشروط.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 text-[15px]">
            جميع المحتويات على موقع هومزمارت بما في ذلك النصوص والصور والتصاميم والبرمجيات
            هي ملكية فكرية حصرية لهومزمارت أو المرخصين له، ويحظر نسخها أو إعادة استخدامها دون إذن مسبق.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 text-[15px]">
            يحتفظ هومزمارت بحق تعديل شروط الاستخدام في أي وقت دون إشعار مسبق.
